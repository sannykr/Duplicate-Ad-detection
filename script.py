...
def prep_train():
    ...
    pairs = pd.read_csv("ItemPairs_train.csv", dtype=types1, nrows=1000)
    # Add 'id' column for easy merge
    print("Load ItemInfo_train.csv")
    items = pd.read_csv("ItemInfo_train.csv", dtype=types2, nrows = 1000)
    items.fillna(-1, inplace=True)
    location = pd.read_csv("Location.csv", nrows = 1000)
    category = pd.read_csv("Category.csv", nrow = 1000)
...
def prep_test():
    ...
    pairs = pd.read_csv("ItemPairs_test.csv", dtype=types1, nrows = 1000)
    print("Load ItemInfo_testcsv")
    items = pd.read_csv("ItemInfo_test.csv", dtype=types2, nrows = 1000)
    items.fillna(-1, inplace=True)
    location = pd.read_csv("Location.csv", nrows = 1000)
    category = pd.read_csv("Category.csv", nrows = 1000)
